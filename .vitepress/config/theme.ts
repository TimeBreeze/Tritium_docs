...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  editLink: {
    pattern: 'https://github.com/TimeBreeze/Tritium_docs/edit/main/docs/:path',
    text: '不妥之处，敬请雅正'
  },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/TimeBreeze/Tritium' },
    {
      icon: {
      ...
      link: 'https://gitee.com/TimeBreeze/Tritium'
    }
  ],
