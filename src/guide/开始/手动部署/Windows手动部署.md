...
title: Windows 手动部署
---
# Windows 云崽 bot-v3 安装步骤

***~~我太懒了，索性直接搬运一闪大佬写的教程，受虐滑稽.jpg~~***
[[toc]]
...
- <img src="/img/2图片.jpg" width="50%"> <br> MISCONF Redis is configured to save RDB
  snapshots
...
- 喵喵插件的 `#xx照片` `xx图片` 功能用不了？
  ...
  - <img src="/img/1图片.jpg" width="50%"> 删除 `Yunzai-Bot/plugins/miao-plugin/resources/miao-res-plus` 文件夹，然后发送
